...
<div class="menu">
    <ul>
        ...
        <li class="menu-item hidden"><a href="movies">Movies</a></li>
        <li class="menu-item hidden"><a href="shows">TV Shows</a></li>
        <li class="menu-item hidden"><a href="people">People</a></li>
        <li class="menu-item hidden"><a href="categories">Categories</a></li>
        <li class="menu-item hidden"><a href="recs">Recommendations</a></li>
